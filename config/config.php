...
$config['db']['dbuser']   = 'mps';
$config['db']['dbpwd']    = 'AJKJHDSKGKHASDHSGDGDGSH';
$config['db']['dbname']   = 'mps';
$config['db']['pconnect'] = 0;
$config['db']['tablepre'] = 'sdw_';
$config['db']['charset']  = 'GBK';
// COOKIE 设置
$config['cookie']['cookiepre'] 	   = 'skdjfkdjfk_'; 	// COOKIE前缀
$config['cookie']['cookiedomain']  = '.countycn.com'; 		// COOKIE作用域
...
$config['authkey']	 = 'SLFJDJFJEIOHFIODSHFILJDFLIJDLFJLDSHF';	// 站点加密密钥
