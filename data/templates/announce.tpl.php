...
<title>网站公告_<?php echo $config['sitename']?></title>
...
<div class="blank"></div>
<div class="wrap yourpos"><a href="/">县域中国</a> > 网站公告</div>
<?php if(is_array($articles)) { foreach($articles as $article) { ?>
<div class="wrap announce">
<h3><?php echo $article['title']?></h3>
<div>发布时间：<?php echo $article['dateline']?>　发布人：<?php echo $article['poster']?></div>
